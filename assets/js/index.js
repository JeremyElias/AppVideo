'use strict';
/**
 * importar todos los elementos y funciones
 */
...
const genreList = {
    ...
    //crear una lista con los generos de la api

    asString(genreIdList){
        let newGenreList = [];
        for (const genreId of genreIdList){
            this[genreId] && newGenreList.push(this[genreId]); //agrega el genero a la lista
        }
...
const heroBanner = function({results: movieList}){
    ...
    for (const [index, movie] of movieList.entries()){
     ...
     <div class="banner-content">
      ...
      alt="deslice ${title}" loading="lazy"
